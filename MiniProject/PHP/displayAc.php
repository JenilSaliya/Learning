    ...
    <div class="container flex  f1">
        ...
        <main class="main">
            ...
            <div class="records">
                ...
                global $connect;
                $ac_id=$_GET['ac_id'];
                $selectEx="select * from expense where user_id=$_SESSION[user_id] and ac_id=$ac_id order by date desc ";
                ...
                <?php
                global $connect;
                $selectIn = "select * from income where user_id=$_SESSION[user_id] and ac_id=$ac_id order by date desc";
